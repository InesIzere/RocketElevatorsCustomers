...
{
    public partial class shimwe_mysqlContext : DbContext
    {
        public shimwe_mysqlContext()
        {
        }

        public shimwe_mysqlContext(DbContextOptions<shimwe_mysqlContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseMySQL("server=codeboxx.cq6zrczewpu2.us-east-1.rds.amazonaws.com;user id=codeboxx;password=Codeboxx1!;port=3306;database=rocketelevators_development;");
            }
        }
